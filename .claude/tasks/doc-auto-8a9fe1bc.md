# doc_auto task — C:\\pjt\\orchestration_v1\\.claude\\scripts\\verify-render-coverage.py

## Diff (HEAD)
```
diff --git a/.claude/scripts/verify-render-coverage.py b/.claude/scripts/verify-render-coverage.py
new file mode 100644
index 0000000..7c2916b
--- /dev/null
+++ b/.claude/scripts/verify-render-coverage.py
@@ -0,0 +1,250 @@
