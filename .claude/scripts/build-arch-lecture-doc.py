...
CHAPTERS = [
    ...
    # ---- 9. RAG 입문 ----
    {
        ...
        "우리시스템": {
            "현재 상태": "RAG 미구현 (spec-only — ai_rag plugin 로드맵)",
            "대안": "메모리 (~/.claude/projects/<proj>/memory/) 가 사실상 단순 RAG — 매 세션 컨텍스트 로드",
            "향후": "ChromaDB + LlamaIndex 로 사내 doc 검색 가능 (exec_offline-vector)",
        },
