...
AREAS = [
    ...
    # ───── 영역 14: 데이터-AI 거버넌스 ─────
    ('[STAT]', '14. 데이터-AI 거버넌스', '데이터 관리-AI 라이프사이클', [
...
<div class="nav">
  <strong>[LIST] 300 신상품 목차 (30 영역)</strong>
{nav_html}
</div>

<div class="hero">
  <h1>[TGT] ITCEN CORE × Llama 4 — 300 신상품 카탈로그</h1>
