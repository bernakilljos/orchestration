...
AREAS = [
    ...
    ('🐟', '수산·해양', 'Ocean AI'),
    ('🌳', '임업·산림', 'Forest AI'),
    ('♻️', '재활용·환경', 'Circular AI'),
    ('🚰', '수자원·수도', 'Water AI'),
    ('⚱️', '폐기물', 'Waste AI'),
    ('🌋', '재난·재해', 'Disaster AI'),
    ('🏛️', '문화재·문화', 'Heritage AI'),
    # ── 라이프·소비 (10) ──
    ('🍽️', '식품·외식', 'F&B AI'),
    ('💄', '패션·뷰티', 'Fashion AI'),
    ('🎮', '게임·메타버스', 'Game AI'),
...
<div class="nav">
<strong>📋 100 영역 (3000)</strong>
{nav_html}
</div>

<div class="hero">
  <h1>🎯 ITCEN CORE × Llama 4 — 100 신기술 영역 × 3000 신상품</h1>
