...
| 13 | ✏ 교정 & 번역 | 7 | 문법 검사, 스타일 가이드, 다국어 번역 |
...
## 2⃣ 참고문헌 관리 (Citation Management)
...
## 3⃣ 논문 작성 (Manuscript Preparation)
...
## 6⃣ 설문 & 데이터 수집 (Survey & Data Collection)
...
## 7⃣ 질적 연구 (Qualitative Research & NVivo)
...
## 8⃣ 데이터 시각화 - 학술 (Academic Visualization)
...
## 9⃣ 재현성 & 재생산성 (Reproducibility & Containers)
...
## 1⃣1⃣ AI 연구 도구 (AI-Powered Research Tools)
...
## 1⃣2⃣ 프레젠테이션 (Academic Presentations)
...
## 1⃣3⃣ 교정 & 번역 (Proofreading & Translation)
...
## 1⃣4⃣ 한국 학술 플랫폼 (Korean Academic Platforms)
