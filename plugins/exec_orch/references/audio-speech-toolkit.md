...
| 13 | 🎛️ 스템 분리 | 4 | 보컬·악기 분리, 원본 복원 |
| 14 | 🎙️ 팟캐스트/방송 | 6 | 라이브 스트리밍, 편집, 호스팅 |
...
## 3️⃣ 음성 명령 (Voice Commands & Wake Word Detection)
...
## 4️⃣ 회의록/전사 (Meeting Transcription & Diarization)
...
## 5️⃣ 오디오 편집 (Audio Editing & Processing)
...
## 6️⃣ 노이즈 제거 (Noise Reduction & VAD)
...
## 8️⃣ 음성 클로닝 (Voice Cloning & Conversion)
...
## 9️⃣ 감정 분석 (Emotion & Sentiment Analysis)
...
## 1️⃣1️⃣ MIDI (Music Notation & Control)
...
## 1️⃣2️⃣ 작곡 AI (AI Music Generation)
...
## 1️⃣3️⃣ 스템 분리 (Source Separation)
...
## 1️⃣4️⃣ 팟캐스트/방송 (Podcasting & Streaming)
